                		...
                		<div class="row mt-4 shadow">                			
                			<%
								try{
						            ...
						            ResultSet rs = stmt1.executeQuery("select * from add_shop"); 
						            ...
						            <table class="table">
									  <thead>
									    <tr>
									      ...
									      <th class="text-center" scope="col">Shop Address</th>
									      <th class="text-center" scope="col">Phone</th>
									      <th class="text-center" scope="col">No Of Barber</th>
									      <th class="text-center" scope="col">Owner Name</th>
									   ...
									   while (rs.next()) 
							             {  
										     String id=rs.getString("id");
										   	 String qf1 = rs.getString("sname");
							                 String of1 = rs.getString("saddress");  
							                 String of2 = rs.getString("phone");  
							                 String of3 = rs.getString("nbarber");  
							                 String of4 = rs.getString("oname");  
							               ...
							               %>
											    ...
											    <tr>
												      ...
												      <td class="text-center"> <a href="http://localhost:2020/webcont/delete_shop?id=<% out.print(id); %>" class="btn btn-danger"> Delete </a> </td>
											    </tr>
							               <%   
